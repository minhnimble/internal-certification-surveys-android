...
interface BaseFragmentCallbacks {
     ...
     *
     * This method usually get called multiple times, whenever the Fragment view is
     * being created/re-created. Ideally, you would want to setup your RecyclerView,
     * ViewPager here (without the data involvement).
     *
     ...
     *
     * This method usually get called multiple times, whenever the Fragment view is
     * being created/re-created. Ideally, you would want to setup your input events like:
     ...
     *
     * This method usually get called multiple times, whenever the Fragment view is
     * being created/re-created. Ideally, you would want to setup the data binding from
     * ViewModel to View here.
     *
     * This is called right after [BaseFragment.onViewCreated]
     */
    fun bindViewModel()
